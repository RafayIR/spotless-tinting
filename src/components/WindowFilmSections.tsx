...
const recentAutomotiveProjects: {
...
}[] = [
  {
    id: 'g1',
    category: 'Sedans',
    image: '/portfolio-images/lexus-es-hybrid-silver/lexus-6.jpeg',
    alt: 'Lexus ES Hybrid with professionally installed automotive window tint',
  },
  {
    id: 'g2',
    category: 'SUVs',
    image: '/portfolio-images/bmw-x-full-windows-legal-tint/bmw-2.jpeg',
    alt: 'BMW X5 with dark automotive window film',
  },
  {
    id: 'g3',
    category: 'Utes',
    image: '/portfolio-images/isuzu-vmax-nano-ceramic-tint/isuzu-1.jpg',
    alt: 'Isuzu V-Max ute with nano ceramic window tinting',
  },
  {
    id: 'g4',
    category: 'Sports',
    image: '/portfolio-images/holden-monaro-cv/holden-1.jpeg',
    alt: 'Holden Monaro with premium window tint',
  },
  {
    id: 'g5',
    category: 'Sedans',
    image: '/portfolio-images/silver-toyota-camry-hybrid/silver-1.jpeg',
    alt: 'Toyota Camry Hybrid showing window tint finish',
  },
  {
    id: 'g6',
    category: 'SUVs',
    image: '/portfolio-images/mitsubishi-outlander/mitsubishi-1.jpeg',
    alt: 'Mitsubishi Outlander with automotive window film installed',
  },
];
